...
class FixedBonusStrategyTest extends TestCase
{
     ...
     * @test
     */
    public function should_calculate_sucessfully_befoure_first_year_of_work()
    {
        // given
     ...
     * @test
     */
    public function should_calculate_sucessfully_after_first_year_of_work()
    {
        $departmentBonus = new DepartmentBonus('2cb509e2-a0e6-4d87-a44a-36f27b4ab13b', DepartmentBonusType::Fixed, 3000);
     ...
     * @test
     */
    public function should_calculate_sucessfully_after_few_years_first_year_of_work()
    {
        $departmentBonus = new DepartmentBonus('2cb509e2-a0e6-4d87-a44a-36f27b4ab13b', DepartmentBonusType::Fixed, 3000);
     ...
     * @test
     */
    public function should_calculate_sucessfully_over_ten_years()
    {
        $departmentBonus = new DepartmentBonus('2cb509e2-a0e6-4d87-a44a-36f27b4ab13b', DepartmentBonusType::Fixed, 3000);
